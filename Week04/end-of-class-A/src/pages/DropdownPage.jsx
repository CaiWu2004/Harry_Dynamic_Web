...
const DropdownPage = () => {
  ...
  if (value?.value) {
    //Array.filter takes a callback function
    // that recieves each objecy one at a time (s) and
    // A condition that needs to be true, to keep/filter that object
    filteredData = DATA_TO_FILTER.filter((s) => {
      //this statement need to be true to
      // keep this individual s in our array
      //in this single line functionm we don't need {} and return
